...
function Functionality() {
    ...
    this.check_verify = function (board){
    ...
    this.mate_verify = function (board){
        if(this.check_verify(board) == "white"){
            let x = 0, y = 0;
            for(i = 0; i < 8; i++){
                for(j = 0; j < 8; j++){
                    if(board[i][j] == 6){
            ...
            let v = this.main(string, board);
            if(v.length == 0){
                return true;
            }
        }
        if(this.check_verify(board) == "black"){
            let x = 0, y = 0;
            for(i = 0; i < 8; i++){
                for(j = 0; j < 8; j++){
                    if(board[i][j] == 12){
